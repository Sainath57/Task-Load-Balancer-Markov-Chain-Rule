...
try {
			...
			String h1 = bi1.toString(16);
				...
				Statement st=connection.createStatement();
								...
								String sk="Not Mentioned";
st.executeUpdate("update charm_cloudserver set ct='"+encryptedValue+"' ,mac='"+h1+"'  where fname='"+file+"'");

st.executeUpdate("insert into charm_attacker (user,fname,cname,sk,type,dt) values('Attacker','"+file+"','"+cld+"','"+sk+"','Content Attack','"+dt+"')");

			%>
            <p></p>
            <h2 class="style28">Data Attacked  !</h2>
            </p>
            <a href="Attack.jsp">Back</a><br />
            <%
