...
.style5 {font-size: 18px; color: #FFFF00; }
-->
</style>
</head>
<body>
...
<p>&nbsp;</p><p>&nbsp;</p>
	<tr>
		...
		<option>Aliyun OSS</option>
			...
			<tr>
		<td bgcolor="#FF0000" class="style5">Select VM :-</td>
		<td><input type="text" name="vm" class="text" value="VM1"/></td>
	</tr>
			<tr>
		<td bgcolor="#FF0000" class="style5">Select VM Memory :-</td>
