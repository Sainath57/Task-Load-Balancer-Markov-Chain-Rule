...
<table width="598" border="1" align="center">
	...
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style6">VM Memory :- </span></td>
		<td width="356"><input name="t42" type="text" id="t42" size="50"
			value="<%= vm%>" readonly="readonly" /></td>
	</tr>
	
	<tr>
		<td bgcolor="#FF0000"><span class="style6">Cost:- </span></td>
	...
	<tr>
		...
		<td><input type="submit" name="Submit2" value="Perform" /></td>
       		...
       		%>
       		<h1 class="style7">The Memory U choosen is not Available </h1>
       		<%
       	}
    	}catch(Exception e){
    		e.printStackTrace();
