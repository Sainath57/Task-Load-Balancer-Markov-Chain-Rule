...
<div class="article">
  ...
  <tr>
   <td bgcolor="#FF0000" ><div align="center" class="style4"><span class="style3"><strong>FileName</strong></span></div></td>
      <td bgcolor="#FF0000" ><div align="center" class="style4"><span class="style3"><strong>OwnerName</strong> </span></div></td>
    <td bgcolor="#FF0000" ><div align="center" class="style4"><span class="style3"><strong>Uploaded Date</strong></span></div></td>
  </tr>
        
     <%

	String s1="",s2="",s3="",s4="",s5="",s6="",s7="",s8,s9="",s10,s11,s12,s13,ct1="";
	int i=0,j=0,k=0;
	...
	if(decryptedValue1.toLowerCase().contains(keyword.toLowerCase()) || s2.toLowerCase().contains(keyword.toLowerCase()) )	
					{
		%>
