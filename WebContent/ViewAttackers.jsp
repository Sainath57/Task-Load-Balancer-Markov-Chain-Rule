...
<div class="main">
  ...
  <tr>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style6">User Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style6">File Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style6">Cloud Name </div></td>
    <td width="178" bgcolor="#FF0000"><div align="center" class="style6">Secret Key </div></td>
    <td width="115" bgcolor="#FF0000"><div align="center" class="style6">Type </div></td>
...
String cn=(String) application.getAttribute("cloudName");
      	try 
	{
      		...
      		String cld="Not Mentioned";
      		 
      		
      		String query="select * from charm_attacker where cname='"+cn+"' or cname='"+cld+"' "; 
