...
<br />
<td>
<button onClick="saveTextAsFile()">Download</button></td>
</div>
</label>
<p align="center">&nbsp;</p>
<p>
...
<p class="style4"><a href="Download.jsp">Back</a></p>
<span class="style4">
<%
		}
					}
...
<p class="style4">
<h1 class="style4">Wrong Credential Ur Automatically Blocked in <%=cname %> !!!</h1>
<h2 class="style4">Please contact Cloud Server Admin</h2>
</p>
<span class="style4"><br />
</p>
</span>
<p class="style4">
<h1 class="style4">Hash Code / Secret Key Mismatch !!!</h1>
</p>
<span class="style4"><br />
</span>
<p class="style4"><a href="Download.jsp">Back</a></p>
...
<p class="style4">
<h1 class="style4">U Dont Have Permission To DownLoad File!!!</h1>
<h2 class="style4">Please contact Cloud Server Admin</h2>
</p>
<br />
...
<p><a href="EndUserMain.jsp">Back</a></p>                </p>
</div>
<div class="clr"></div>
</div>
</div>
