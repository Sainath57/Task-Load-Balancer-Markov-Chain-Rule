...
<div class="main">
  ...
  <tr>
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style5">USER Name </div></td>
     <td width="293" bgcolor="#FF0000"><div align="center" class="style5">OwnerName</div></td>     
      <td width="293" bgcolor="#FF0000"><div align="center" class="style5">CloudName</div></td>     
       <td width="293" bgcolor="#FF0000"><div align="center" class="style5">FnameReq </div></td>
      <td width="293" bgcolor="#FF0000"><div align="center" class="style5">Sk</div></td>
    <td width="115" bgcolor="#FF0000"><div align="center" class="style5">Requested Date </div></td>
        <td width="115" bgcolor="#FF0000"><div align="center" class="style5">Response Date </div></td>
            <td width="115" bgcolor="#FF0000"><div align="center" class="style5">Status </div></td>
  </tr>
<%
...
<tr>
	...
	<div align="center"><%=s8%></div>	</td>
		<td>
	<div align="center"><a href="response.jsp?id=<%=i %>&name=<%=s2 %>&cname=<%=s4 %>&fname=<%=s5 %>"><%=s9%></a></div>	</td>
</tr>
