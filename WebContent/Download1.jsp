      ...
      <br/>
       ...
       <%
            ...
            <table width="478" border="0" align="center">
              <tr>
                <td width="223"><span class="style6">Enter File Name :-</span></td>
                <td width="245"><label>
                  <input required name="t1" type="text" value="<%=file%>" size="40" />
                </label></td>
              </tr>
			   <tr>
            <td width="223"><span class="style6">Owner Name:-</span></td>
             <td>   <select id="s1" name="oname" style="width:150px;" class="text">
			    ...
			    <tr>
            <td width="223"><span class="style6">User Name:-</span></td>
             <td>   <input name="un" type="text"  size="40" value="<%=un %>">
              ...
              <tr>
                <td height="34"><span class="style6">Hash Code :-</span></td>
