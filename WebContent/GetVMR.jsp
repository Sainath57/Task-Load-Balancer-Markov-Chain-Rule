...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
   <h1><a href="index.html"><span class="style7">ProjectName</span></a></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
...
<p>&nbsp;</p><p>&nbsp;</p>
	<tr>
		<td bgcolor="#FF0000" class="style11">Enter Cloud Name :-</td>
		<td bgcolor="#FF0000"><select	name="cloudn" class="text style10" id="s1">
		...
		<tr>
		<td bgcolor="#FF0000" class="style4 style11">Select VM Memory :-</td>
		<td bgcolor="#FF0000"><select	name="vmm" class="text style10" id="s1">
...
<br/><br/><br/>
  ...
  <tr>
  <td width="293" bgcolor="#FF0000"><div align="center" class="style9">Memory Size</div></td>     
   <td width="140" height="32" bgcolor="#FF0000"><div align="center" class="style9">Cloud Cost in <span class="WebRupee">&#x20B9;</span></div></td>
 <td width="293" bgcolor="#FF0000"><div align="center" class="style9">Cloud Name </div></td>
  </tr>
