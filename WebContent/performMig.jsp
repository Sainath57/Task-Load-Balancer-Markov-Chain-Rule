...
<h2 class="style5"><%=length %> <%=re %> <%=rm %> ,<%=r %></h2>
<span class="style5">
<%
...
<h2 class="style5">The Upload limit is reached</h2>
<span class="style5">
<%
           }
...
<h2 class="style5">Migrated Successfully <%=mcloud %> and deleted ur existing vm in <%=cloud %></h2>
<span class="style5">
<%
...
<h2 class="style5">U Doesn't Have any Files in <%=cloud %> cloud</h2>
			   <span class="style5">
			   <%
		   }
		}catch(Exception e){
		...
		%>
		    ...
		    <h2 class="style5">Ur Not Registered to this <%=mcloud %> cloud</h2>
<%
	}
